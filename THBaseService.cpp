        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->gets.resize(_size107);
            uint32_t _i111;
            for (_i111 = 0; _i111 < _size107; ++_i111)
            {
              xfer += this->gets[_i111].read(iprot);
            }
            iprot->readListEnd();
          }
          isset_gets = true;
...
uint32_t THBaseService_getMultiple_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("gets", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter112 = this->gets.begin(); _iter112 != this->gets.end(); ++_iter112)
    {
...
uint32_t THBaseService_getMultiple_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("gets", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter113 = (*(this->gets)).begin(); _iter113 != (*(this->gets)).end(); ++_iter113)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->puts.resize(_size125);
            uint32_t _i129;
            for (_i129 = 0; _i129 < _size125; ++_i129)
            {
              xfer += this->puts[_i129].read(iprot);
            }
            iprot->readListEnd();
          }
          isset_puts = true;
...
uint32_t THBaseService_putMultiple_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("puts", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter130 = this->puts.begin(); _iter130 != this->puts.end(); ++_iter130)
    {
...
uint32_t THBaseService_putMultiple_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("puts", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter131 = (*(this->puts)).begin(); _iter131 != (*(this->puts)).end(); ++_iter131)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->deletes.resize(_size132);
            uint32_t _i136;
            for (_i136 = 0; _i136 < _size132; ++_i136)
            {
              xfer += this->deletes[_i136].read(iprot);
            }
            iprot->readListEnd();
          }
          isset_deletes = true;
...
uint32_t THBaseService_deleteMultiple_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("deletes", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter137 = this->deletes.begin(); _iter137 != this->deletes.end(); ++_iter137)
    {
...
uint32_t THBaseService_deleteMultiple_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("deletes", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter138 = (*(this->deletes)).begin(); _iter138 != (*(this->deletes)).end(); ++_iter138)
    {
...
void THBaseServiceProcessor::process_exists(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.exists", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.exists");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.exists");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.exists", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.exists");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.exists");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.exists", bytes);
  }
}
...
void THBaseServiceProcessor::process_get(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.get", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.get");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.get");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.get", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.get");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.get");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.get", bytes);
  }
}
...
void THBaseServiceProcessor::process_getMultiple(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.getMultiple", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.getMultiple");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.getMultiple");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.getMultiple", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.getMultiple");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.getMultiple");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.getMultiple", bytes);
  }
}
...
void THBaseServiceProcessor::process_put(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.put", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.put");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.put");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.put", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.put");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.put");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.put", bytes);
  }
}
...
void THBaseServiceProcessor::process_checkAndPut(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.checkAndPut", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.checkAndPut");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.checkAndPut");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.checkAndPut", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.checkAndPut");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.checkAndPut");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.checkAndPut", bytes);
  }
}
...
void THBaseServiceProcessor::process_putMultiple(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.putMultiple", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.putMultiple");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.putMultiple");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.putMultiple", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.putMultiple");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.putMultiple");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.putMultiple", bytes);
  }
}
...
void THBaseServiceProcessor::process_deleteSingle(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.deleteSingle", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.deleteSingle");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.deleteSingle");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.deleteSingle", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.deleteSingle");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.deleteSingle");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.deleteSingle", bytes);
  }
}
...
void THBaseServiceProcessor::process_deleteMultiple(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.deleteMultiple", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.deleteMultiple");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.deleteMultiple");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.deleteMultiple", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.deleteMultiple");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.deleteMultiple");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.deleteMultiple", bytes);
  }
}
...
void THBaseServiceProcessor::process_checkAndDelete(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.checkAndDelete", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.checkAndDelete");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.checkAndDelete");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.checkAndDelete", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.checkAndDelete");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.checkAndDelete");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.checkAndDelete", bytes);
  }
}
...
void THBaseServiceProcessor::process_increment(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.increment", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.increment");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.increment");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.increment", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.increment");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.increment");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.increment", bytes);
  }
}
...
void THBaseServiceProcessor::process_append(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.append", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.append");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.append");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.append", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.append");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.append");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.append", bytes);
  }
}
...
void THBaseServiceProcessor::process_openScanner(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.openScanner", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.openScanner");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.openScanner");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.openScanner", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.openScanner");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.openScanner");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.openScanner", bytes);
  }
}
...
void THBaseServiceProcessor::process_getScannerRows(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.getScannerRows", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.getScannerRows");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.getScannerRows");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.getScannerRows", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.getScannerRows");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.getScannerRows");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.getScannerRows", bytes);
  }
}
...
void THBaseServiceProcessor::process_closeScanner(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.closeScanner", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.closeScanner");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.closeScanner");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.closeScanner", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.closeScanner");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.closeScanner");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.closeScanner", bytes);
  }
}
...
void THBaseServiceProcessor::process_mutateRow(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.mutateRow", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.mutateRow");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.mutateRow");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.mutateRow", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.mutateRow");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.mutateRow");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.mutateRow", bytes);
  }
}
...
void THBaseServiceProcessor::process_getScannerResults(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("THBaseService.getScannerResults", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "THBaseService.getScannerResults");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "THBaseService.getScannerResults");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "THBaseService.getScannerResults", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "THBaseService.getScannerResults");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "THBaseService.getScannerResults");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "THBaseService.getScannerResults", bytes);
  }
}
