...
typedef struct _TDelete__isset {
  _TDelete__isset() : columns(false), timestamp(false), deleteType(false), attributes(false), durability(false) {}
  bool columns;
  bool timestamp;
  bool deleteType;
  bool attributes;
...
typedef struct _TScan__isset {
  _TScan__isset() : startRow(false), stopRow(false), columns(false), caching(false), maxVersions(false), timeRange(false), filterString(false), batchSize(false), attributes(false), authorizations(false) {}
  bool startRow;
  bool stopRow;
  bool columns;
  bool caching;
